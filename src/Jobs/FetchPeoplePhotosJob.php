...
use JOOservices\XFlickrCrawler\Support\PeoplePhotosParams;
use Throwable;
...
final class FetchPeoplePhotosJob extends AbstractXFlickrCrawlJob
{
    public function handle(
        ...
        $apiMethod = 'flickr.people.getPhotos';
        $started = hrtime(true);
        ...
        try {
            ...
            $response = $client->raw()->call(
                $apiMethod,
                PeoplePhotosParams::query($target->subject_nsid, $target->page, $fetcher->perPage()),
            );
